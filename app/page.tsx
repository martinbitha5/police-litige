...
const FEATURES = [
  { title: 'Suivi des litiges', desc: 'Tous les bagages d’un vol, filtrables par jour, statut et chargement.' },
  { title: 'Réclamations passager', desc: 'Les signalements passagers arrivent directement dans la file de traitement.' },
  { title: 'Rapport journalier', desc: 'Export Excel des litiges de la journée en un clic.' },
];
  ...
  return (
    <main style={s.shell}>
      <div style={s.container}>
        ...
        <h1 style={s.title}>Litige Bagage</h1>
        <p style={s.tagline}>
          Espace superviseur : suivi et résolution des litiges et réclamations bagage.
        </p>
...
const s: Record<string, CSSProperties> = {
  ...
  badge: { ...glass, borderRadius: 999, padding: '5px 14px', fontSize: 13, fontWeight: 700, color: '#93c5fd', letterSpacing: 0.5 },
  ...
  cta: { marginTop: 8, background: 'var(--primary)', color: '#fff', borderRadius: 12, padding: '14px 32px', fontWeight: 800, fontSize: 16, boxShadow: '0 12px 30px rgba(37,99,235,0.45)' },
  grid: { marginTop: 24, width: '100%', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 14 },
