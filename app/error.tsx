...
const card: React.CSSProperties = {
  background: 'var(--bg-neutral, rgba(22,51,0,0.08))',
  border: 'none',
  borderRadius: 24,
  padding: 32,
  maxWidth: 420,
...
const btnPrimary: React.CSSProperties = { background: 'var(--interactive-accent, #9FE870)', color: 'var(--interactive-control, #163300)', border: 'none', borderRadius: 9999, padding: '10px 20px', fontWeight: 600, cursor: 'pointer' };
const btnGhost: React.CSSProperties = { background: 'transparent', color: 'var(--interactive-primary, #163300)', borderWidth: 1, borderStyle: 'solid', borderColor: 'var(--interactive-primary, #163300)', borderRadius: 9999, padding: '10px 20px', fontWeight: 600, cursor: 'pointer' };
